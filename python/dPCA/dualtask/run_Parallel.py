...
# Get inputs and outputs from example trials
    ...
    return [acc_dpa, acc_gng, state, task_type, acc_dpa_dual, acc_gng_dual,
            acc_dpa_dpa, acc_gng_gng, pred_out, inputs, outputs, stim_conf, vec_tau]
            ...
            for noise in noise_rng:
                ...
                for neuron in num_neurons:
                    ...
                    for i in range(INST):
                        ...
                        pred_out.append(ops[i][8])
                        output.append(ops[i][10])
                        inputs.append(ops[i][9])
                        stim_conf.append(ops[i][11])
                        vec_tau.append(ops[i][12])
